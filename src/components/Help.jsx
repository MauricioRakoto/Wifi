                ...
                <div className="col-12 col-lg-6">
                    <div className="card border-0 shadow-sm rounded-4 p-4 bg-white mb-4">
                        ...
                        <div className="p-3 bg-warning bg-opacity-10 border border-warning border-opacity-20 rounded-3">
                            <p className="small text-dark mb-0">
                                <strong>Le saviez-vous ?</strong> Vous pouvez surveiller la consommation globale de tous
                                vos postes en un coup d'œil via le badge "Données" en haut de la page de gestion.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="card border-0 shadow-sm rounded-4 p-4 bg-light">
                        ...
                        <p className="small text-muted">
                            Si vous fermez l'application sans "Terminer" les sessions, les calculs de durée
                            s'arrêteront, mais les sessions resteront dans l'état "En cours". Pensez à toujours valider
                            la fin d'une session pour vos recettes.
                        </p>
                    </div>
                </div>
            </div>
